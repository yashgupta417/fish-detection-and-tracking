...
for frame_no=36:1661
    ...
    for i=1:cluster
        ...
        for j=1:n1
            ...
            if index==-1
                ...
                path='C:\Users\HP\Desktop\research intern\output1\objects';
    ...
    for i=1:size_details(1)
        ...
        h=sprintf("C:\\Users\\HP\\Desktop\\research intern\\output1\\objects\\object%d.txt",details(i,1));
        fid = fopen(h,'a+');
        fprintf(fid,'%f,%f,%f,%d\r\n',details(i,2),details(i,3),details(i,4),frame_no); 
        fclose(fid);
        
        %storing the bounding box of all objects in a common file
        h1="C:\Users\HP\Desktop\research intern\output1\result_detailed.txt";
        fid = fopen(h1,'a+');
    ...
    fName= fullfile("C:\Users\HP\Desktop\research intern\output1\images\", sprintf('%06d.jpg', frame_no));
    imwrite(bsi,fName);
    
    %store the number of objects detected in the frame in the file
    h2="C:\Users\HP\Desktop\research intern\output1\result.txt"; 
    fid = fopen(h2,'a+');
