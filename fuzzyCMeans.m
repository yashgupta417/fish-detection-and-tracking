...
for frame_no=36:1661
    ...
    for i=1:size_details(1)
        ...
        h=sprintf("C:\\Users\\HP\\Desktop\\research intern\\output\\objects\\object%d.txt",details(i,1));
        fid = fopen(h,'a+');
        fprintf(fid,'%f,%f,%f,%f\r\n',details(i,2),details(i,3),details(i,4),frame_no); 
        fclose(fid);
        
        %storing the bounding box of all objects in a common file
        h1="C:\Users\HP\Desktop\research intern\output\result_detailed.txt";
        fid = fopen(h1,'a+');
    ...
    fName= fullfile("C:\Users\HP\Desktop\research intern\output\images\", sprintf('%06d.jpg', frame_no));
    imwrite(bsi,fName);
    
    %store the number of objects detected in the frame in the file
    h2="C:\Users\HP\Desktop\research intern\output\result.txt"; 
    fid = fopen(h2,'a+');
